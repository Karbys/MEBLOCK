...
const CallToAction: React.FC = () => {
  ...
  return (
    <PageSection
      id="discover"
      className="items-center justify-between gap-10 rounded-[40px] border border-strong gradient-cta text-cta-primary shadow-elevated transition-colors duration-500 lg:flex-row"
    >
      ...
      <div className="flex flex-col items-start gap-4 lg:items-end">
        <Link
          ...
          className="btn-contrast inline-flex items-center justify-center rounded-full px-8 py-3 text-sm font-semibold shadow-card transition hover:translate-y-[1px]"
        >
          {t.cta.primaryCta}
        </Link>
